...
class Game:
    def __init__(self):
        ...
        self.active = True # active game -> to collision
        ...
        self.plane = Plane(self.all_sprites, self.scale_factor / 40.9)
        self.obstacle = Obstacle(self.all_sprites, self.scale_factor)
        # timer
