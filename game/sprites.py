...
class Plane(pygame.sprite.Sprite):
    ...
    def rotate(self, dt):
        rotated_plane = pygame.transform.rotozoom(self.image, -self.direction * 0.07, 1)
...
class Obstacle(pygame.sprite.Sprite):
    def __init__(self, groups, scale_facotr):
        ...
        self.image = pygame.transform.scale(surf, pygame.math.Vector2(surf.get_size()) * scale_facotr)
